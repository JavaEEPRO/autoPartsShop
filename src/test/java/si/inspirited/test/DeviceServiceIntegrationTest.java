...
import si.inspirited.StoreAppUp;
...
@SpringBootTest(classes = {StoreAppUp.class, TestDbConfig.class, TestIntegrationConfig.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
