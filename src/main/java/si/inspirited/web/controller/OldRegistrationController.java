...
import si.inspirited.persistence.model.PasswordResetToken;
...
public class OldRegistrationController {
    ...
    public String showRegistrationForm(final HttpServletRequest request, final CookieLocaleResolver clr, final Model model) {
        LOGGER.debug("Rendering registration page.");
        final UserDto accountDto = new UserDto();
        model.addAttribute("user", accountDto);
        //model.addAttribute("currentLocale", clr.resolveLocale(request));
        return "registration";
    }

    @RequestMapping(value = "/registrationConfirm", method = RequestMethod.GET)
    public String confirmRegistration(final HttpServletRequest request,  final CookieLocaleResolver clr, final Model model, @RequestParam("token") final String token) {
        final Locale locale = clr.resolveLocale(request);  //request.getLocale();
    ...
    public ModelAndView registerUserAccount(@ModelAttribute("user") @Valid final UserDto userDto, final HttpServletRequest request, final CookieLocaleResolver clr, final Errors errors) {
